...
const showcases = [
  ...
  { emoji: '🌐', title: 'Conference Universe', desc: 'Sponsor rooms, networking zones, main stages for thousands.', tag: 'For Events', tagColor: 'blue', href: '/market' },
]
    ...
    <div className="relative z-10">
      ...
      <section className="max-w-7xl mx-auto pt-32 md:pt-40 pb-20 px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center gap-10 md:gap-16">
        <div className="flex-1 max-w-[600px]">
          ...
          >
            Not a chat app. Not a game. Rooms where you walk in, see who&apos;s around, and talk naturally — with people and bots that have memories, feelings, and real tools to help.
          </motion.p>
