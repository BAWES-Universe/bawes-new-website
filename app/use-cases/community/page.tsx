...
const details = [
  {
    ...
    desc: 'Host meetups, town halls, and social events in spatial worlds. Proximity chat creates natural conversation circles just like real life.',
  },
  {
    title: 'Shared Interest Spaces',
    desc: 'Create dedicated worlds for gaming, art, music, or any shared passion. Members can explore, collaborate, and connect around common interests.',
  },
  {
    title: 'Event Management',
    desc: 'Schedule events with integrated calendars, send notifications, and manage capacity. Set up ticketing, RSVPs, and automated reminders for your community.',
  },
  {
    title: 'Moderation & Safety',
    desc: 'Equip community leaders with moderation tools — mute, kick, ban, and lock discussions. Create safe, welcoming spaces for every member.',
  },
]
        ...
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/70 leading-relaxed max-w-2xl mx-auto">
              Build thriving communities in spatial worlds. BAWES gives you the tools to create spaces where people connect, collaborate, and belong.
            </p>
          </motion.div>
        </div>
      </section>
