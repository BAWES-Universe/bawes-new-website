...
const features = [
  { key: 'maps', icon: 'map' },
  { key: 'mapTemplates', icon: 'content_copy' },
  { key: 'inlineMapEditor', icon: 'edit_square' },
  { key: 'areaZones', icon: 'widgets' },
  { key: 'entityEditor', icon: 'view_in_ar' },
  { key: 'scriptingApi', icon: 'code' },
  { key: 'teleport', icon: 'near_me' },
  { key: 'searchable', icon: 'search' },
  { key: 'maps', icon: 'group' },
  { key: 'maps', icon: 'face_6' },
]
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {features.map((feature, i) => {
              ...
              return (
              <Link key={feature.key + '-' + i} href={featureSlugs[t(titleKey)] || `/features/${feature.key}`} className="group">
              <motion.div
