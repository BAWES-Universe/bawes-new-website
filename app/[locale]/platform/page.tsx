...
const features = [
  { key: 'selfHosting', icon: 'dns' },
  { key: 'adminApi', icon: 'api' },
  { key: 'oidcAuth', icon: 'vpn_key' },
  { key: 'whiteLabel', icon: 'palette' },
  { key: 'techStack', icon: 'layers' },
]
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {features.map((feature, i) => {
              ...
              const slugKey = t(titleKey)
              return (
              <Link key={feature.key} href={featureSlugs[slugKey] || `/features/${feature.key}`} className="group">
              <motion.div
