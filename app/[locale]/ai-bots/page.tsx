...
const features = [
  { key: 'botBehaviors', icon: 'psychology' },
  { key: 'botMemory', icon: 'memory' },
  { key: 'botStreaming', icon: 'message' },
  { key: 'botToolCalling', icon: 'handyman' },
  { key: 'botAvatars', icon: 'face' },
  { key: 'botEmotions', icon: 'favorite' },
  { key: 'botGreetings', icon: 'waving_hand' },
  { key: 'botProviderConfig', icon: 'settings' },
  { key: 'recursiveBots', icon: 'device_hub' },
  { key: 'botEditor', icon: 'edit' },
]
