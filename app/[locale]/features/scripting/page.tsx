        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Link href="/features/map-editor" className="glass-card p-6 rounded-xl flex flex-col items-center text-center gap-3 hover:border-purple-500/40 transition-all group">
              ...
              <span className="text-purple-400 text-xs font-bold flex items-center gap-1 group-hover:gap-2 transition-all">{t('learnMore')} <span className="material-symbols-outlined text-sm">{arrowIcon}</span></span>
            </Link>
