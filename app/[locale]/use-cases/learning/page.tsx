    ...
    <main className="pt-20" dir={isRtl ? 'rtl' : 'ltr'}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-0 pb-2">
        <div className="flex items-center gap-2 text-xs text-text-muted">
          ...
          <span className="text-primary">{t('learning')}</span>
        </div>
      </div>
        ...
        <div className="max-w-container-max mx-auto px-gutter grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="z-10">
            <h1 className="font-display-hero text-display-hero mb-6 text-white leading-tight">
              {t('learningTitle')} <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-[#8b5cf6] to-[#3b82f6]">{t('learningTitleGradient')}</span>
            </h1>
      ...
      <section className="py-section-padding-v relative">
        <div className="max-w-container-max mx-auto px-gutter">
          <div className="text-center mb-16">
            <h2 className="font-headline-section text-headline-section text-on-surface mb-4">{t('howItWorks')}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter">
            <div className="glass-card p-8 rounded-xl">
              ...
              <h3 className="font-headline-card text-headline-card text-on-surface mb-4">{t('walkIntoClass')}</h3>
              <p className="font-body-md text-body-md text-text-secondary">{t('walkIntoClassDesc')}</p>
            </div>
            <div className="glass-card p-8 rounded-xl">
              <div className="w-12 h-12 bg-secondary/20 rounded-lg flex items-center justify-center mb-6">
                <span className="material-symbols-outlined text-secondary">groups</span>
              </div>
              <h3 className="font-headline-card text-headline-card text-on-surface mb-4">{t('studyGroups')}</h3>
              <p className="font-body-md text-body-md text-text-secondary">{t('studyGroupsDesc')}</p>
            </div>
            <div className="glass-card p-8 rounded-xl">
              ...
              <h3 className="font-headline-card text-headline-card text-on-surface mb-4">{t('officeHours')}</h3>
              <p className="font-body-md text-body-md text-text-secondary">{t('officeHoursDesc')}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-section-padding-v bg-surface-container-lowest/30">
        <div className="max-w-container-max mx-auto px-gutter flex flex-col lg:flex-row gap-16 items-start">
          <div className="lg:sticky lg:top-32 lg:w-1/3">
            <h2 className="font-headline-section text-headline-section text-on-surface mb-6">{t('keyFeatures')}</h2>
            ...
            <div className="p-6 glass-card rounded-xl border-primary/40 bg-primary/5">
              <div className="flex items-center gap-4 text-primary mb-2">
                ...
                <span className="font-label-navigation text-label-navigation">{t('livekitEnabled')}</span>
              </div>
              <p className="text-caption font-caption text-text-low-emphasis">{t('livekitDesc')}</p>
            </div>
          </div>
          <div className="lg:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="glass-card p-6 rounded-xl">
              <span className="material-symbols-outlined text-primary mb-4 text-3xl">meeting_room</span>
              <h4 className="font-bold text-lg mb-2">{t('lectureHalls')}</h4>
              <p className="text-text-low-emphasis text-sm">{t('lectureHallsDesc')}</p>
            </div>
            <div className="glass-card p-6 rounded-xl">
              <span className="material-symbols-outlined text-secondary mb-4 text-3xl">groups</span>
              <h4 className="font-bold text-lg mb-2">{t('studyRooms')}</h4>
              <p className="text-text-low-emphasis text-sm">{t('studyRoomsDesc')}</p>
            </div>
            <div className="glass-card p-6 rounded-xl">
              <span className="material-symbols-outlined text-tertiary mb-4 text-3xl">badge</span>
              <h4 className="font-bold text-lg mb-2">{t('mentorOffices')}</h4>
              <p className="text-text-low-emphasis text-sm">{t('mentorOfficesDesc')}</p>
            </div>
            <div className="glass-card p-6 rounded-xl">
              <span className="material-symbols-outlined text-primary mb-4 text-3xl">campaign</span>
              <h4 className="font-bold text-lg mb-2">{t('eventBroadcasts')}</h4>
              <p className="text-text-low-emphasis text-sm">{t('eventBroadcastsDesc')}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-container-max mx-auto px-gutter py-section-padding-v">
        <h2 className="font-headline-section text-headline-section text-center mb-16">{t('scenarios')}</h2>
        <div className="grid md:grid-cols-3 gap-8">
          <div className="glass-card rounded-2xl overflow-hidden">
            ...
            <div className="p-8">
              <h3 className="font-headline-card text-headline-card mb-4">{t('universities')}</h3>
              <p className="text-text-secondary">{t('universitiesDesc')}</p>
            </div>
          </div>
          <div className="glass-card rounded-2xl overflow-hidden">
            <div className="h-48 bg-surface-container-high flex items-center justify-center">
            ...
            <div className="p-8">
              <h3 className="font-headline-card text-headline-card mb-4">{t('codingBootcamps')}</h3>
              <p className="text-text-secondary">{t('codingBootcampsDesc')}</p>
            </div>
          </div>
          <div className="glass-card rounded-2xl overflow-hidden">
            <div className="h-48 bg-surface-container-high flex items-center justify-center">
            ...
            <div className="p-8">
              <h3 className="font-headline-card text-headline-card mb-4">{t('workshopsTraining')}</h3>
              <p className="text-text-secondary">{t('workshopsTrainingDesc')}</p>
            </div>
          </div>
        </div>
      </section>
