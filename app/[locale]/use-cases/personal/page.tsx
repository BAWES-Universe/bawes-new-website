    ...
    <main className="pt-20" dir={isRtl ? 'rtl' : 'ltr'}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-0 pb-2">
        <div className="flex items-center gap-2 text-xs text-text-muted">
          ...
          <span className="text-primary">{t('personal')}</span>
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <Link href="/ai-bots" className="text-primary font-bold inline-flex items-center gap-2 group/link">
                Explore Bot Features <span className="material-symbols-outlined text-base transition-transform group-hover/link:translate-x-1">{arrowIcon}</span>
              </Link>
            </div>
