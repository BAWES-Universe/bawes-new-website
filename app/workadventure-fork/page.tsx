...
const details = [
  {
    title: 'Built on WorkAdventure',
    desc: 'BAWES is a fork of the open-source WorkAdventure project. We extend the foundation with new features while maintaining upstream compatibility.',
  },
  {
    title: 'Extended Feature Set',
    desc: 'Adds AI-powered bots, advanced scripting, enhanced communication tools, and a richer map ecosystem beyond what WorkAdventure provides out of the box.',
  },
  {
    title: 'Upstream Alignment',
    desc: 'We actively track upstream WorkAdventure releases and merge compatible changes. The fork stays aligned while adding BAWES-specific innovations.',
  },
  {
    title: 'Community-Driven Evolution',
    desc: 'The fork direction is shaped by community needs. Feature requests and contributions from WorkAdventure users inspire our development priorities.',
  },
]
        ...
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6">
              <span className="text-gradient">WorkAdventure Fork</span>
            </h1>

            <p className="text-xl md:text-2xl text-white/70 leading-relaxed max-w-2xl mx-auto">
              BAWES builds upon the open-source WorkAdventure project, extending it with powerful new capabilities while honoring its collaborative roots.
            </p>
          </motion.div>
        </div>
      </section>
