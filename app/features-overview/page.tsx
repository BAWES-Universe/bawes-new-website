...
const details = [
  {
    ...
    desc: 'Browse the complete catalog of BAWES capabilities — from AI bots and scripting to communication and spatial tools — all in one organized view.',
  },
  {
    title: 'Categorized for Clarity',
  ...
  },
  {
    ...
    desc: 'Every feature links to its dedicated detail page with in-depth information, use cases, configuration guides, and best practices.',
  },
]
        ...
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6">
              <span className="text-gradient">Features Overview</span>
            </h1>

            <p className="text-xl md:text-2xl text-white/70 leading-relaxed max-w-2xl mx-auto">
              A complete view of everything BAWES offers. Explore every feature, tool, and capability in one organized hub with quick access to details.
            </p>
          </motion.div>
        </div>
      </section>
