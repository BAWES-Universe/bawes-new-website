...
const features = [
  { title: 'Custom Avatars', icon: 'person_edit', description: 'Upload custom images or generate AI-powered avatars for each bot to give them a unique visual identity.' },
  { title: 'Animated Expressions', icon: 'emoji_people', description: 'Avatars come alive with animated facial expressions — smile, think, wave — tied to bot emotional states.' },
  { title: 'VRM & GLB Support', icon: 'view_in_ar', description: 'Import 3D avatar models in VRM and GLB formats for full spatial presence in your universe.' },
  { title: 'Dynamic Outfits', icon: 'checkroom', description: 'Change avatar outfits and accessories dynamically based on context, mood, or user preference.' },
]
        ...
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6">
              <span className="text-white">Bot Avatars</span>
            </h1>

            <p className="text-xl md:text-2xl text-white/70 leading-relaxed max-w-2xl mx-auto">
              Customize bot appearances with unique avatars and visual identities. From 2D portraits to full 3D spatial models.
            </p>
          </motion.div>
        </div>
      </section>
