...
const details = [
  {
    title: 'RESTful Management',
    desc: 'Full REST API for programmatic platform management — create rooms, manage users, configure permissions, deploy maps, and automate workflows.',
  },
  {
    title: 'Authentication & Authorization',
    desc: 'Secure API with API key and OAuth2 authentication. Granular permission scopes let you control exactly what each integration can do.',
  },
  {
    title: 'Webhook Events',
    desc: 'Subscribe to real-time webhook events for room activity, user presence, zone triggers, and system alerts. Build reactive integrations.',
  },
  {
    title: 'SDKs & Client Libraries',
    desc: 'Official SDKs for TypeScript, Python, and Go. Auto-generated OpenAPI specs let you create clients in any language.',
  },
]
        ...
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6">
              <span className="text-gradient">Admin API</span>
            </h1>

            <p className="text-xl md:text-2xl text-white/70 leading-relaxed max-w-2xl mx-auto">
              Full REST API for programmatic platform management and automation. Build integrations, automate workflows, and control your universe at scale.
            </p>
          </motion.div>
        </div>
      </section>
