...
const details = [
  {
    title: 'Define Interactive Zones',
    desc: 'Draw zones directly on your map — rectangles, circles, or freeform polygons. Each zone can trigger actions when people walk through them.',
  },
  {
    title: 'Permission Boundaries',
    desc: 'Control who can enter, interact, or edit within each zone. Create public areas with private cores — access control is spatial, not global.',
  },
  {
    title: 'Zone Triggers & Events',
    desc: 'Attach scripts and events to zones: teleport on entry, play audio, show notifications, change lighting, or spawn objects.',
  },
  {
    title: 'Visual Zone Editor',
    desc: 'See all zones overlaid on your map with color-coded boundaries. Edit, resize, and rearrange zones without digging through configuration files.',
  },
]
        ...
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6">
              <span className="text-gradient">Area Zones</span>
            </h1>

            <p className="text-xl md:text-2xl text-white/70 leading-relaxed max-w-2xl mx-auto">
              Define interactive zones that trigger actions when people walk through them. Make your rooms alive and responsive.
            </p>
          </motion.div>
        </div>
      </section>
