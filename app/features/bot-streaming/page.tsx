...
const features = [
  { title: 'Real-Time Tokens', icon: 'speed', description: 'Stream response tokens as they are generated for instant, low-latency conversational feedback.' },
  { title: 'Cancel & Regenerate', icon: 'replay', description: 'Users can cancel mid-stream or regenerate responses without losing context.' },
  { title: 'Typing Indicators', icon: 'keyboard', description: 'Show realistic typing indicators and allow bots to signal intent before responding.' },
  { title: 'Markdown Rendering', icon: 'code', description: 'Streamed markdown — code blocks, tables, and inline formatting — renders live as tokens arrive.' },
]

export default function BotStreaming() {
        ...
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6">
              <span className="text-white">Bot Streaming Chat</span>
            </h1>

            <p className="text-xl md:text-2xl text-white/70 leading-relaxed max-w-2xl mx-auto">
              Real-time streaming responses for natural conversational flow. See replies form word by word, just like chatting with a human.
            </p>
          </motion.div>
        </div>
      </section>
