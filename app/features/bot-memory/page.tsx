...
const features = [
  { title: 'Conversation History', icon: 'history', description: 'Bots retain full conversation history across sessions, enabling long-running context-aware dialogues.' },
  { title: 'Vector Memory', icon: 'database', description: 'Store embeddings in a vector database for semantic recall — bots remember meaning, not just words.' },
  { title: 'User-Scoped Memory', icon: 'person_outline', description: 'Each user gets their own memory namespace so bots personalize responses based on past interactions.' },
  { title: 'Memory Summarization', icon: 'summarize', description: 'Automatically summarize and compress long histories to stay within context windows without losing key details.' },
]

export default function BotMemory() {
        ...
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6">
              <span className="text-white">Bot Memory</span>
            </h1>

            <p className="text-xl md:text-2xl text-white/70 leading-relaxed max-w-2xl mx-auto">
              Persistent memory so bots remember past conversations and context. Retain history, recall semantics, and personalize every interaction.
            </p>
          </motion.div>
        </div>
      </section>
