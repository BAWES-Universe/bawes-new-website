...
const details = [
  {
    ...
    desc: 'Place and position entities — doors, portals, signs, triggers, NPCs, and custom objects — anywhere on your map with drag-and-drop simplicity.',
  },
  {
    title: 'Property Configuration',
    desc: 'Configure every entity property: position, rotation, scale, interactivity, animations, and custom metadata. All entities are data-driven.',
  },
  {
    title: 'Scriptable Behaviors',
    desc: 'Attach scripts to any entity to define custom behaviors. Open doors, activate effects, trigger conversations, or chain complex interactions.',
  },
  {
    title: 'Entity Library & Presets',
    desc: 'Browse a library of ready-made entities with preset configurations. Save your own entities as presets for reuse across maps.',
  },
]
        ...
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6">
              <span className="text-gradient">Entity Editor</span>
            </h1>

            <p className="text-xl md:text-2xl text-white/70 leading-relaxed max-w-2xl mx-auto">
              Place, configure, and manage interactive entities on your maps. Bring your rooms to life with doors, portals, signs, and more.
            </p>
          </motion.div>
        </div>
      </section>
