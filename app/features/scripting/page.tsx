...
const details = [
  {
    title: 'Full Scripting API',
    desc: 'A powerful JavaScript/TypeScript API for custom behaviors, game logic, and integrations. Script anything from door animations to complex game mechanics.',
  },
  {
    title: 'Event-Driven Architecture',
    desc: 'React to player actions — movement, chat, zone entry, entity interaction. Build responsive environments that feel alive.',
  },
  {
    title: 'External Integrations',
    desc: 'Connect your universe to external services via webhooks, REST APIs, and WebSocket bridges. Pull in live data, trigger external actions, and build dashboards.',
  },
  {
    title: 'Script Manager',
    desc: 'Upload, version, and manage scripts through an in-browser editor. Enable, disable, or hot-reload scripts without restarting the room.',
  },
]
        ...
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6">
              <span className="text-gradient">Scripting API</span>
            </h1>

            <p className="text-xl md:text-2xl text-white/70 leading-relaxed max-w-2xl mx-auto">
              Extend functionality with a powerful scripting API for custom logic, game mechanics, and integrations. Create living worlds.
            </p>
          </motion.div>
        </div>
      </section>
