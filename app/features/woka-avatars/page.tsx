...
const details = [
  {
    ...
    desc: 'Create and customize avatars with a rich set of options — hairstyles, outfits, accessories, skin tones, and more. Express your unique identity.',
  },
  {
    title: 'Woka Character System',
    desc: 'The Woka system provides cute, expressive character models with emotes, animations, and customizable features. Perfect for social spaces.',
  },
  {
    title: 'Animation & Emotes',
    desc: 'Express yourself with a library of animations and emotes. Walk, run, wave, dance, sit — your avatar mirrors your presence naturally.',
  },
  {
    title: 'Avatar Marketplace',
    desc: 'Browse and collect avatar items from the marketplace. Support creators, unlock exclusive items, and build the perfect look for your persona.',
  },
]
        ...
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6">
              <span className="text-gradient">Woka Avatars</span>
            </h1>

            <p className="text-xl md:text-2xl text-white/70 leading-relaxed max-w-2xl mx-auto">
              Custom avatar creation and management platform for all users. Express your identity with unique, customizable character models.
            </p>
          </motion.div>
        </div>
      </section>
