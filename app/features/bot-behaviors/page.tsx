...
const features = [
  { title: 'State Machines', icon: 'alt_route', description: 'Define complex state-based behaviors that transition between idle, active, responding, and learning states.' },
  { title: 'Reactive Triggers', icon: 'bolt', description: 'Bots react to events — user joins, message received, proximity detected — with custom response chains.' },
  { title: 'Scheduled Actions', icon: 'schedule', description: 'Program bots to perform actions on a timer: daily greetings, periodic reminders, or timed announcements.' },
  { title: 'Behavior Trees', icon: 'account_tree', description: 'Design hierarchical behavior trees with conditions, sequences, and fallbacks for sophisticated interactions.' },
]

export default function BotBehaviors() {
        ...
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6">
              <span className="text-white">Bot Behaviors</span>
            </h1>

            <p className="text-xl md:text-2xl text-white/70 leading-relaxed max-w-2xl mx-auto">
              Define complex behavioral patterns for your AI bots. From reactive triggers to scheduled actions and behavior trees — make your bots feel alive.
            </p>
          </motion.div>
        </div>
      </section>
