...
const features = [
  { title: 'Emotional States', icon: 'mood', description: 'Bots have configurable emotional states — happy, sad, curious, annoyed — that shift based on conversation context.' },
  { title: 'Mood-Driven Responses', icon: 'tonality', description: 'Response tone, word choice, and personality shift dynamically based on the bot\'s current emotional state.' },
  { title: 'Emotion Decay & Recovery', icon: 'trending_down', description: 'Emotions naturally decay over time or recover based on positive interactions, creating realistic mood cycles.' },
  { title: 'Emotion Triggers', icon: 'dynamic_feed', description: 'Define custom triggers — keywords, user sentiment, events — that cause emotional shifts in your bots.' },
]

export default function BotEmotions() {
        ...
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6">
              <span className="text-white">Bot Emotions</span>
            </h1>

            <p className="text-xl md:text-2xl text-white/70 leading-relaxed max-w-2xl mx-auto">
              Emotional states and mood-driven responses for lifelike interactions. Give your bots feelings that change and evolve.
            </p>
          </motion.div>
        </div>
      </section>
