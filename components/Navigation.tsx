          ...
          <div className="flex items-center justify-between h-20 w-full min-w-0 gap-2" style={{ width: '100%', maxWidth: '100%', boxSizing: 'border-box' }}>
            ...
            <div className="hidden lg:flex items-center gap-6 flex-shrink-0">
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#5865F2] hover:bg-[#4752C4] text-white text-sm font-medium transition-all whitespace-nowrap"
            ...
            <div className="lg:hidden flex items-center flex-shrink-0">
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                className="flex items-center gap-1.5 min-h-[44px] h-10 sm:h-11 px-2.5 sm:px-3 rounded-lg bg-[#5865F2] hover:bg-[#4752C4] text-white text-xs sm:text-sm font-medium transition-all touch-manipulation mr-[10px]"
                aria-label="Join us on Discord"
